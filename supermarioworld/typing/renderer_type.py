...
class DaemonModernGL_Context:
    def program(vertex: str, fragment: str): ...
    def vertex_array(program, attributes: list[tuple], index_buffer: tuple): ...

class BasicRenderer:
    _ctx: DaemonModernGL_Context
    def beginScene(self, scene_name) -> None: ...

    def deleteFbo(self, frame_key: str) -> None: ...
    def createFbo(self, frame_key: str, size: tuple, persistent=False) -> None: ...
    def beginFbo(self, frame_key: str) -> None: ...
    def endFbo(self) -> None: ...

    def createBuffer(self, data: list[float]) -> object: ...
    

    def regShader(self, shader_key: str, your_shader: CustomShader, persistent=False) -> None: ...
